...
import { Palette, Image as ImageIcon, LayoutGrid, Info, Wand2 } from 'lucide-react';
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {themeColor && (
                                    <button
                                        type="button"
                                        onClick={() => {
                                            const theme = getTheme(themeColor as ThemeColor);
                                            onChange('qr_code_fg_color', theme.primary);
                                        }}
                                        className="inline-flex items-center gap-1 text-[11px] font-semibold text-[#E85A70] hover:text-[#d94f65] transition-colors"
                                    >
