...
export function HeroSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative flex items-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-[#FFF5F7] via-[#FDF2F4] to-[#F8F9FA]"
    ...
    >
      ...
      <div className="absolute -top-32 -left-32 w-[500px] h-[500px] bg-[#E85A70] opacity-[0.06] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#E85A70] opacity-[0.05] rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-12 gap-5 items-stretch">
          ...
          >
            <div className="absolute top-0 right-0 w-80 h-80 bg-[#E85A70] opacity-[0.10] rounded-full blur-3xl pointer-events-none" />
