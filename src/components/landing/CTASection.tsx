    ...
    <section ref={ref} className="py-24 px-4 sm:px-6 lg:px-8 bg-[#F8F9FA]">
      <div className="max-w-5xl mx-auto">
        <div className={`bento-card overflow-hidden transition-all duration-1000 ${
          ...
          <div
            className="relative p-12 sm:p-20 flex flex-col items-center text-center"
            style={{ background: 'linear-gradient(135deg, #FFE8EC 0%, #FDF2F4 40%, #FFD6DC 100%)' }}
          >
            {/* Decorações */}
            <div className="absolute top-0 left-0 w-full h-full opacity-70"
              style={{
                backgroundImage: 'radial-gradient(circle at 15% 140%, rgba(232,90,112,0.55) 0%, transparent 55%), radial-gradient(circle at 85% -40%, rgba(225,29,72,0.45) 0%, transparent 55%), radial-gradient(circle at 50% 50%, rgba(232,90,112,0.06) 0%, transparent 70%)'
              }}
            />
