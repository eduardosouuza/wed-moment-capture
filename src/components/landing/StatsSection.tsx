...
export function StatsSection() {
  ...
  return (
    <section ref={ref} className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#FDF2F4] via-[#F8F9FA] to-white">
      <div className="max-w-7xl mx-auto">
        
        {/* Usando o formato Bento como na aba de preços do Memoly */}
        <div
          className={`bento-card p-12 transition-all duration-1000 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
          style={{ background: 'linear-gradient(135deg, #FDF2F4 0%, #FFFFFF 45%, #FFF5F7 100%)' }}
        >
