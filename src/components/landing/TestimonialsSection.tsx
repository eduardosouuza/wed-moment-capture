...
export function TestimonialsSection() {
  ...
  return (
    <section ref={ref} className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#F8F9FA] via-[#FDF2F4] to-[#F8F9FA]">
          ...
          {testimonials.map((t, i) => (
            <div
              ...
              style={{
                ...
                background: 'linear-gradient(145deg, #FFFFFF 55%, #FFF5F7 100%)',
              }}
            >
              {/* Estrelas */}
