...
import { Check, Zap, Crown, Sparkles, ArrowLeft, ArrowRight, Shield, Camera } from 'lucide-react';
...
const plans: Plan[] = [
    ...
    },
    {
        ...
        photoCount: '300 fotos + vídeos',
        icon: Sparkles,
        accent: 'text-purple-600',
        accentBg: 'bg-purple-50',
        photoBg: 'bg-purple-50',
        photoText: 'text-purple-700',
    ...
    },
    {
        ...
        name: 'Premium',
        price: 99.90,
        idealGuests: 'Ideal para grandes eventos',
        photoCount: 'Ilimitado',
        icon: Crown,
        accent: 'text-amber-600',
        accentBg: 'bg-amber-50',
        photoBg: 'bg-amber-50',
        photoText: 'text-amber-700',
        buttonStyle: 'bg-gray-900 hover:bg-gray-800 text-white',
        features: [
            'Eventos ilimitados',
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:gap-8 items-start">
                    {plans.map((plan) => (
                        ...
                        >
                            ...
                            <div className={`flex items-center gap-2 px-4 py-3 rounded-2xl ${plan.photoBg} mb-6`}>
                                <Camera className={`w-4 h-4 ${plan.photoText} shrink-0`} />
                                <span className={`text-sm font-bold ${plan.photoText}`}>
                                    {plan.photoCount}
                                </span>
                                <span className={`text-xs ${plan.photoText} opacity-70 ml-auto`}>
                                    por evento
                                </span>
                            </div>
